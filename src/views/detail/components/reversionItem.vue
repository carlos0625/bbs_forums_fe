<template>
  <div class="reversion-item">
    ...
    <div class="reversion-item" v-for="(reversion, index) in reversions" :key="index">
      ...
      @click="go(newComment2, commentId, reversion.id, reversion.username, reversion)"
      >发表</el-button>
...
export default {
  ...
  methods: {
    ...
    go (content, commentId, reversionId, rusername, reversion) {
      let data = {}
